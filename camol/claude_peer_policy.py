...
def execution_policy():
    return dict(customizations="restricted_explicit_settings", managed_policy="host_applies",
        peer_capability_exposure="worker_environment", peer_startup="observed_before_completion",
...
def validate(profile):
    if (profile.adapter_kind != "claude_cli" or profile.provider != "anthropic"
            or profile.execution_policy != execution_policy() or profile.peer_policy is None
