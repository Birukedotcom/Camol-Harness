...
The repository regression gate currently runs 325 tests with `python3 -m unittest
...
matrix-theme assertions, real-PTY and interrupted-login Ctrl+C detach, owner-only event-store
files, reattach boundaries, login-identity propagation,
